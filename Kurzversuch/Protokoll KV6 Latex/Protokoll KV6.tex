...
\begin{figure}[H]
	...
	\label{fig: iod2od}
\end{figure}
Bei der Betrachtung des Iod-Spektrums (siehe \autoref{fig: iod2spek}) ist zu sehen, dass bei der Messung des Iod-Spektrums deutlich weniger von dem Signal angekommen ist, als bei der Aufnahme des Interferenz-Filter-Spektrums. Dadurch ist das Rauschen deutlich prominenter zu sehen.\\
