...
Now the four-bounce crystal-monochromator is turned on and then off again to record the reduction of the spectral bandwidth. Then the dispersive single-shot spectrum analyser is used to record the spectrum of the pink X-ray beam with a bragg angle of 24°. 
...
\begin{figure}[h]
     \centering
     \includegraphics[scale=0.4]{img/Reference_Spectrum.png}
     \caption{The reference spectra plotted with provided data for different spin states.}
...
\begin{figure}[h]
     \centering
     \includegraphics[scale=0.4]{img/Reference_Spectrum.png}
     \caption{The reference difference spectra with transient signals plotted with provided data for different transitions.}
     \label{fig:ref diff spectra}
\end{figure}

\subsection{XES spectra at 100ps}
When plotting the XES spectrum and the difference spectrum for a time delay of \qty{100}{ps}(see \autoref{fig:100ps all spec}), a clear transient signal is recognisable with the expected peaks from the reference spectrum (see \autoref{fig:ref diff spectra}). The XES spectrum shows similarities with the singlet spectrum from the reference (see \autoref{fig:ref spectra}).

\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{img/100ps spektrum.png}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{img/100ps diff spektrum.png}
        %diese grafiken müssen adjusted werden was größe der beschriftung angeht
        \caption{Difference spectrum at a delay of \qty{100}{ps}.}
