...
![[tris(2,2'-bipyridine)iron(II).png]]
...
![[Pasted image 20260912213648.png]]

\subsubsection{Photophysics / HS LS states}
Fowlling Hund's rule the lower-energy orbitals (t2g) are filled first (one by one with electrons of the same spin).
...
\begin{figure}[h]
     \centering
     \includegraphics[scale=0.5]{img/fit_with_quarlets.png}
...
\begin{figure}[h]
     \centering
     \includegraphics[scale=0.5]{img/Reference_Spectrum.png}
...
\begin{figure}[h]
     \centering
     \includegraphics[scale=0.4]{img/Differences_Reference_Spectrum.png}
