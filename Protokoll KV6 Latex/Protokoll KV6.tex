...
\caption{Hilfsfunktionen für die Korrekturfunktion}
\end{figure}

\begin{figure}[H]
       \centering
       \includegraphics[scale=0.75]{img/Code_Korrekturfunktion.png}
       \caption{Korrekturfunktion}
\end{figure}
...
1. Wie erklärt sich die spektrale Verteilung der Weisslicht-LED?
...
$$B=f_{max}-f_{min}=\frac{c}{\lambda_{min}}-\frac{c}{\lambda_{max}}=\frac{c}{493\text{nm}}-\frac{c}{521\text{nm}}=$$
Die Zentralwellenlänge $\lambda_Z$ liegt bei $\lambda_Z=\frac{c}{}
